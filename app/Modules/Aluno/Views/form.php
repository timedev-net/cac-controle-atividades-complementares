  ...
  <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
    ...
    <form class="bg-white dark:bg-meuTema-800 p-8" method="post" action="<?= empty($a) ? '/aluno/novo' : "/aluno/editar/$a->id" ?>">
      ...
      <div class="mb-6">
        ...
        <input name="matricula_suap" value="<?= empty($a) ? '' : $a->matricula_suap ?>" type="text" id="matricula_suap" class="bg-meuTema-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-meuTema-500 focus:border-meuTema-500 block w-full p-2.5 dark:bg-meuTema-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-meuTema-500 dark:focus:border-meuTema-500" required>
      ...
      <div class="mb-6">
        ...
        <input name="email" value="<?= empty($a) ? '' : $a->email ?>" type="email" id="email" class="bg-meuTema-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-meuTema-500 focus:border-meuTema-500 block w-full p-2.5 dark:bg-meuTema-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-meuTema-500 dark:focus:border-meuTema-500" required>
