...
<?php if(!empty($this->data['message'])) : ?>
    ...
    <div class="fixed top-5 right-5 min-w-[300px]">
        ...
        <?php if(!empty($this->data['message']['info'])) : ?>
            <div id="toast-warning" class="flex items-center min-w-full max-w-xs p-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
