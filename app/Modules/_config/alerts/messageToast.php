...
<?php if(!empty($this->data['message'])) : ?>
    ...
    <div class="fixed top-5 right-5 min-w-[300px]">
        <?php if(!empty($this->data['message']['success'])) : ?>
            <div id="toast-success" class="opacity-0 ease-in-out duration-700 flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
        ...
        <?php if(!empty($this->data['message']['error'])) : ?>
            <div id="toast-danger" class="opacity-0 ease-in-out duration-700 flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
        ...
        <?php if(!empty($this->data['message']['info'])) : ?>
            <div id="toast-warning" class="opacity-0 ease-in-out duration-700 flex items-center min-w-full max-w-xs p-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
