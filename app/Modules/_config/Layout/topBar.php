<nav class="bg-meuTema-50 border-meuCinza-200 dark:bg-meuTema-950 dark:border-meuCinza-700">
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    ...
    <div class="hidden w-full md:block md:w-auto" id="navbar-dropdown">
      <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-meuCinza-100 rounded-lg bg-meuTema-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-meuTema-50 dark:bg-meuTema-800 md:dark:bg-meuTema-950 dark:border-meuCinza-700">
        <li>
          <a href="/" class="block py-2 pl-3 pr-4 text-meuCinza-900 rounded hover:bg-meuTema-100 md:hover:bg-transparent md:border-0 md:hover:text-meuTema-700 md:p-0 dark:text-meuBranco md:dark:hover:text-meuTema-500 dark:hover:bg-meuTema-700 dark:hover:text-meuBranco md:dark:hover:bg-transparent">Home</a>
        </li>
        <li>
          ...
          <div id="dropdownNavbar" class="z-10 hidden font-normal bg-meuTema-50 divide-y divide-meuCinza-100 rounded-lg shadow w-44 dark:bg-meuTema-700 dark:divide-meuCinza-600">
            <ul class="py-2 text-sm text-meuCinza-700 dark:text-meuCinza-400" aria-labelledby="dropdownLargeButton">
              ...
              <li>
                <a href="/tipos-atividades" class="block px-4 py-2 hover:bg-meuTema-100 dark:hover:bg-meuTema-600 dark:hover:text-meuBranco">Tipos de Atividade</a>
              </li>
            </ul>
          </div>
        </li>
        <li>
          ...
          <div id="dropdownNavbar2" class="z-10 hidden font-normal bg-meuTema-50 divide-y divide-meuCinza-100 rounded-lg shadow w-44 dark:bg-meuTema-700 dark:divide-meuCinza-600">
            <ul class="py-2 text-sm text-meuCinza-700 dark:text-meuCinza-400" aria-labelledby="dropdownLargeButton">
              <li>
                <a href="#" class="block px-4 py-2 hover:bg-meuTema-100 dark:hover:bg-meuTema-600 dark:hover:text-meuBranco">Atividades Deferidas</a>
              </li>
              <li>
                <a href="#" class="block px-4 py-2 hover:bg-meuTema-100 dark:hover:bg-meuTema-600 dark:hover:text-meuBranco">Atividades Indeferidas</a>
              </li>
              <li>
                <a href="#" class="block px-4 py-2 hover:bg-meuTema-100 dark:hover:bg-meuTema-600 dark:hover:text-meuBranco">Alunos com pendência na carga horária</a>
              </li>
              <li>
                <a href="#" class="block px-4 py-2 hover:bg-meuTema-100 dark:hover:bg-meuTema-600 dark:hover:text-meuBranco">Alunos com carga horária concluída</a>
              </li>
            </ul>
          </div>
        </li>
